...
const operationLabels: Record<string, string> = {
  ...
  'partial-derivative': 'Partial derivative', 'mixed-partial': 'Mixed partial derivative', gradient: 'Gradient', jacobian: 'Jacobian', hessian: 'Hessian',
  'directional-derivative': 'Directional derivative', linearization: 'Multivariable linearization', 'tangent-plane': 'Tangent plane',
  'multivariable-critical-points': 'Multivariable critical points', 'second-derivative-test': 'Second-derivative test', 'lagrange-multipliers': 'Lagrange multipliers',
  'coordinate-transform': 'Coordinate transformation', 'double-integral': 'Double integral', 'triple-integral': 'Triple integral',
  'vector-field-profile': 'Vector-field profile', divergence: 'Divergence', curl: 'Curl', 'conservative-field': 'Conservative-field test', 'scalar-potential': 'Scalar potential',
  'line-integral': 'Work / circulation line integral', 'scalar-line-integral': 'Scalar line integral', 'surface-integral': 'Scalar surface integral', 'flux-integral': 'Surface flux integral',
  'green-theorem': "Green's theorem", 'gauss-theorem': 'Gauss / divergence theorem', 'stokes-theorem': "Stokes' theorem",
